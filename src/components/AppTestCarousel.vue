    ...
    <div class="sliderContainer  poppins-semibold">
        <div class="containerContent">
            <div class="wrapperContainerLeft">
                <div  class="containerLeft">
                    <div class="containerNUmber">
                        <div class="flex">
                            <p class="indexStyle poppins-semibold ">0</p> 
                            <p class="indexStyle poppins-semibold " :class="{ 'slide-out-down': isAnimating }" @animationend="handleAnimationEnd">{{ sliderElements[currentImageKey].index }}</p>
                        </div>
            ...
            <div class="containerRight">
                <div class="containerRightI">
                    <div v-for="(element, key) in sliderElements" :key="key" >
                    <p :class="{ 'current': key === currentImageKey }" @click="changeImage(key)" class="text-white poppins-semibold textStyle cursor-pointer">{{myToUpperCase(key) }}</p>
                </div>                
            </div>
            </div>
        </div>
...
.forward.activeAnimation {
    animation: slide-in-right 0.9s ease-out both;
}
